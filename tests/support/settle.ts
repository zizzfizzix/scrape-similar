/**
 * Let an unawaited handler finish.
 *
 ...
 * to await. A macrotask turn runs after every pending microtask, and every
 * `await` in a handler whose collaborators are all resolved mocks is a
 * microtask.
 */
